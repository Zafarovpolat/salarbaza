...
**Обновлено:** Февраль 2, 2026

> ⚠️ **Примечание:** Данный файл содержит старую документацию проекта.  
> Актуальная версия: см. [`README.md`](./README.md) в корне проекта.
> 
> 🚀 **Новое ТЗ 2.0:** В разработке находятся новые функции согласно ТЗ 2.0 (оптовые цены, рекомендации товаров, спецпредложения, расширенная админ-панель). См. [`implementation_plan.md`](C:\Users\x\.gemini\antigravity\brain\eb6a1f7c-4bf0-4fc8-8942-ccc7d46f041b\implementation_plan.md)
...
### 🟡 Будущие улучшения (TZ 2.0 - в планах)

1. **Избранное API** - Синхронизация избранного с бэкендом (опционально, сейчас работает через localStorage)
2. **Оптовые цены** - Автоматический расчет скидок при увеличении количества
3. **Рекомендации товаров** - Алгоритм подбора похожих товаров
4. **Спецпредложения** - Виджет с товарами со скидками
5. **База клиентов** - Расширенная CRM в админке
