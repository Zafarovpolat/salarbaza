  ...
  return (
    <div className="pb-4">
      ...
      >
        ...
        />
        {/* Анимированные риплы справа сверху */}
        <motion.div
          animate={{
            scale: [1, 1.1, 1],
          ...
          className="absolute right-0 top-0 w-[300px] h-[300px] rounded-full bg-white z-[1]"
        />
        <motion.div
          animate={{
            scale: [1, 1.15, 1],
          ...
          className="absolute right-[40px] top-[40px] w-[200px] h-[200px] rounded-full bg-white z-[1]"
        />
        <motion.div
          animate={{
            scale: [1, 1.2, 1],
          ...
          className="absolute right-[20px] top-[20px] w-[120px] h-[120px] rounded-full bg-mint z-[1]"
        />
        {/* Акцентные кольца с анимацией */}
        <motion.div
          animate={{
            rotate: [0, 360],
          ...
          className="absolute right-[30px] top-[30px] w-[150px] h-[150px] rounded-full border-2 border-white/20 z-[1]"
          style={{
            borderStyle: "dashed",
            borderSpacing: "10px",
          }}
