...
export function CatalogPage() {
  ...
  return (
    <div className="pb-2">
      ...
      {/* Sort & Filter */}
      <section className="py-3 bg-cream/95 border-b border-stone/30">
        <Container>
      ...
      <section className="py-3">
        <Container>
          <p className="text-sm text-medium-gray">
            {total}{" "}
            {language === "uz" ? "ta mahsulot topildi" : "товаров найдено"}
          </p>
        </Container>
      </section>
  ...
  const priceRanges = [
    {
      min: 0,
      max: 200000,
      label: language === "uz" ? "200 000 gacha" : "До 200 000",
    },
    ...
    { min: 500000, max: 1000000, label: "500 000 - 1 000 000" },
    {
      min: 1000000,
      max: undefined,
      label: language === "uz" ? "1 000 000 dan" : "От 1 000 000",
    },
  ];
      ...
      <div className="p-5 space-y-6">
        ...
        <div className="flex gap-3 pt-4">
          <Button
            variant="ghost"
            fullWidth
            onClick={() => setLocal({ sortBy: "newest" })}
          >
